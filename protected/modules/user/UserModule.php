...
class UserModule extends CWebModule
{
    ...
    public static function sendMail($email, $subject, $message)
    {
        ...
        $mailSMTPSecure = Yii::app()->params["email_SMTPSecure"];
        $mailHost = Yii::app()->params["email_host"];  // specify main and backup server
        $mailPort = Yii::app()->params["email_port"];
        $mailCharSet = 'utf-8';
        $mailSMTPDebug = 1;
